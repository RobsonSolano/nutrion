...
export default function DetalheAvaliacaoPlaceholder() {
    ...
    <>
      ...
      <Screen variant="hero" edges={['top', 'bottom']}>
        <View className="flex-row items-center justify-between px-5 py-3 border-b border-border-subtle">
          ...
          <Text className="text-text font-semibold">Avaliação</Text>
          <View style={{ width: 40 }} />
        </View>
        <View className="flex-1 p-5">
          <Card padding="md">
            ...
            <Text className="text-text-muted text-xs leading-relaxed">
              Visualização e edição da avaliação ({avaliacaoId}) vão entrar
              aqui na próxima fase.
            </Text>
          </Card>
        </View>
      </Screen>
